...
namespace Eads.Web.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ProductName,Description,UnitPrice,Seller,Date,CategoryID,SubcategoryID")]
            Product product, IEnumerable<IFormFile> Image)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProductName,Description,Image,UnitPrice,Seller,Date,CategoryID,SubcategoryID")] Product product)
        {
